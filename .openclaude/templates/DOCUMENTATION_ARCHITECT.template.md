...
Se preferisci salvarlo direttamente sul tuo server o macchinario locale tramite shell, puoi eseguire questo comando di scrittura diretta:

```bash
cat << 'EOF' > DOCUMENTATION_ARCHITECT.template.md
# AARP DOCUMENTATION ARCHITECT - TEMPLATE CONTRACT
